...
The `RADIO_PR` variable has a **moderately concentrated distribution around 100–300**, with a **slight right skew** and at least one **notable outlier** above 400. This suggests that while most cases fall into a typical range, some extreme high values may influence overall statistical analysis.
...
-   Kam, T. S. (2024). *Geographical Segmentation with Spatially Constrained Clustering Techniques*. <https://r4gdsa.netlify.app/chap12.html#correlation-analysis>
