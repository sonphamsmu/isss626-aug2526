...
```{r}
mpsz_sf <- st_read("C:/sonphamsmu/isss626-aug2526/Hands-on_Ex/Hands-on_ex02/data/MasterPlan2019SubzoneBoundaryNoSeaKML.kml") %>% 
...
```{r}
write_rds(mpsz_cl, 
          "C:/sonphamsmu/isss626-aug2526/Hands-on_Ex/Hands-on_ex02/data/mpsz_cl.rds")
```

```{r}
childcare_sf <- st_read("C:/sonphamsmu/isss626-aug2526/Hands-on_Ex/Hands-on_ex02/data/ChildCareServices.kml") %>% 
...
**Conclusion**: Again **Reject H₀**. The distribution of childcare centers is **statistically significantly clustered, not random**.
