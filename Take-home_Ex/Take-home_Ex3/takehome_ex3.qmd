...
| [**gtsummary**](https://www.danieldsjoberg.com/gtsummary/index.html) | Provides an elegant and flexible way to create publication-ready summary tables in R. |
| [**olsrr**](https://olsrr.rsquaredacademy.com/) | R package for building OLS and performing diagnostics tests |
| [**ggplot2**](https://cran.r-project.org/web/packages/ggplot2/index.html) | Provides graphics plots and mappings. |
...
|------------------|------------------|------------------|------------------|
| HDB Resale | Resale flat prices based on registration date from Jan-2017 onwards | CSV | [data.gov.sg](https://data.gov.sg/datasets/d_8b84c4ee58e3cfc0ece0d773c8ca6abc/view) |
| Singapore Master Plan 2019 (URA) Zoning Data | Singapore’s land-use zones: residential, commercial, mixed-use, industrial | KML | [data.gov.sg](https://data.gov.sg/datasets/d_0900fdcfdb4666fe2a630f37a532fc06/view) |
...
| Shopping Mall coordinates | Names of all the shopping malls in Singapore and their respective coordinates. The list was gathered from wikipedia through web scraping and their coordinates were gathered using onemap api. | CSV | [Kaggle](https://www.kaggle.com/datasets/karthikgangula/shopping-mall-coordinates) |
| Eldercare Services | Directory of Eldercare Services (MOH) | KML | [data.gov.sg](https://data.gov.sg/datasets/d_1ee66bb5a41e00b5baadfe00224f649b/view) |
| Hawker Centres (KML) | Directory of Hawker Centres (NEA - National Environment Agency) | KML | [data.gov.sg](https://data.gov.sg/datasets/d_ccca3606c337a5c386b9c88dc0dd08b6/view) |
| LTA MRT Station Exit (KML) | Land Transport Authority. (2018). LTA MRT Station Exit (KML) (2024) \[Dataset\]. *data.gov.sg*. Retrieved October 29, 2025 | KML | [data.gov.sg](https://data.gov.sg/datasets/d_f820139ee3b0865b5512cf61ab7d1122/view) |
| LTA School Zone (KML) | Land Transport Authority. (2016). LTA School Zone (KML) (2024) \[Dataset\]. *data.gov.sg*. Retrieved October 29, 2025 | KML | [data.gov.sg](https://data.gov.sg/datasets/d_7afa83211e3a749d47b7433cd8df3ac2/view) |
| Park Facilities | Contains the representative location of facilities in Parks which are under the purview of the National Parks Board. | GEOJSON | [data.gov.sg](https://data.gov.sg/datasets/d_14d807e20158338fd578c2913953516e/view) |
| Pre-Schools Location | Early Childhood Development Agency. (2023). Pre-Schools Location (2024) \[Dataset\]. data.gov.sg. Retrieved October 29, 2025 | KML | [data.gov.sg](https://data.gov.sg/datasets/d_a72bcd23e208d995f3bd4eececeaca43/view) |
| Supermarkets (KML) | Singapore Food Agency. (2018). Supermarkets (KML) (2024) \[Dataset\]. data.gov.sg. Retrieved October 29, 2025 | KML | [data.gov.sg](https://data.gov.sg/datasets/d_8a77ee0446716b2ce475a587004afc73/view) |
